...
<html>
	...
	<body>
		...
		<section class="container">
			...
			<s:url value="/funcionarios/salvar" var="acaoSalvarFuncionario"/>
			
			<sf:form method="post" modelAttribute="funcionario" action="${acaoSalvarFuncionario}">
				<div class="panel panel-default">
					<div class="panel-heading">
						<s:message code="form.titulo.cadastro" />
					</div>
					...
					<div class="panel-body">
						...
						<div class="form-group">
							<button class="btn btn-default" type="submit">
								...
								<s:message code="form.botao.salvar" />
							</button>
						</div>
					</div>
				</div>			
