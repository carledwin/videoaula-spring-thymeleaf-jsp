...
<html>
	...
	<body>
		    ...
		    <div class="container">
		        ...
		        <div id="navbar" class="collapse navbar-collapse">
		            <ul class="nav navbar-nav">
						...
						<li>
							<a href="<s:url value="/funcionarios"/>">
								<s:message code="menu.funcionarios" />
							</a>
						</li>
		            </ul>
		...
		<section class="container">
			...
			<s:url value="/funcionarios" var="acaoFuncionarios"/>
			
			<sf:form method="post" modelAttribute="funcionario" action="${acaoFuncionarios}">
				<div class="panel panel-default">
					<div class="panel-heading">
						<s:message code="funcionario-lista.form.titulo" />
					</div>
							...
							<div class="col-sm-2">
								<div class="form-group">
									<label class="control-label" for="id">
										<s:message code="funcionario-lista.form.id" />: 
									</label>
								...
								<div class="form-group">
									<label class="control-label" for="codigo">
										<s:message code="funcionario-lista.form.nome" />: 
									</label>
							...
							<div class="col-sm-4">
								<div class="form-group">
									<label class="control-label" for="cpf">
										<s:message code="produto-lista.form.cpf" />: 
									</label>
			...
			<table class="table table-striped table-bordered">
				<thead>
					<tr>
						<th><s:message code="funcionario-lista.tabela.titulo.id" /></th>
						<th><s:message code="funcionario-lista.tabela.titulo.nome" /></th>
						<th><s:message code="funcionario-lista.tabela.titulo.cpf" /></th>
					</tr>
				</thead>
				
				<tbody>
					<c:forEach items="${funcionarios}" var="produto">
						<tr>
